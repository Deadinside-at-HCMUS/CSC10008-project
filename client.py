...
class Client():
    ...
    def gui_loop(self):
        ...
        self.heading.place(x=58, y=60, width=400, height=30)
        ...
        self.intro_button.place(x=284, y=550, width=75, height=30)  
        ...
        self.sign_in_label.place(x=662, y=240)
        ...
        self.forgot_button.place(x=630, y=512)        
        ...
        self.signup_button_label.place(x=720, y=555, width=85, height=35)
