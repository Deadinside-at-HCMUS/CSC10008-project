...
class SignUp:
    def __init__(self, root):
        ...
        self.sign_up_label = Label(self.lgn_frame, text='Sign Up', 
        ...
        Button(self.lgn_button_label, text='SIGN UP', font=("yu gothic ui", 13, "bold"), width=20, bd=0,
                            bg=BLUE, cursor='hand2', activebackground=BLUE, fg=WHITE, highlightthickness=0, command=self.signup_action).place(x=20, y=10)


        self.login_label = Label(self.lgn_frame, text='I have an account!',
                           fg=DARK_GRAY, bg=WHITE, font=('yu gothic ui', 12, "bold"))
        self.login_label.place(x=570, y=570)

        self.login_img = ImageTk.PhotoImage(file='./images/register.png')
        self.login = Button(self.lgn_frame, image=self.login_img, bg=WHITE, cursor="hand2",
        ...
        # Confirm Password
        self.confirm_password_label = Label(self.lgn_frame, text='Confirm Password', bg=WHITE, fg=DARK_GRAY, 
                                    font=('yu gothic ui', 13, 'bold'))
        self.confirm_password_label.place(x=550, y=421)

        self.confirm_password_entry = Entry(self.lgn_frame, highlightthickness=0, relief=FLAT, bg=WHITE, 
                                    fg=DARK_GRAY, font=('yu gothic ui', 13, 'bold'), show='*')
        self.confirm_password_entry.place(x=580, y=457, width=244)

        self.confirm_password_line = Canvas(self.lgn_frame, width=300, height=2.0, highlightthickness=0, bg=LIGHT_GRAY)
        ...
        self.confirm_password_icon_label = Label(self.lgn_frame, image=photo, bg=WHITE)
