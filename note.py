...
class NoteApp():
    ...
    def gui_loop(self, root, user_info):
        ...
        self.add_txt_btn = Button(self.frame2, width=12, pady=8, text='Add Text', font=('yu gothic ui', 13, 'bold'),
        ...
        self.upload_img_btn = Button(self.frame2, width=12, pady=8, text='Upload Image', font=('yu gothic ui', 13, 'bold'),
                                     cursor="hand2", bg=BLUE, fg=WHITE, border=0, relief=FLAT, highlightthickness=0, command=self.upload_image)
        self.upload_img_btn.place(x=0, y=140)

        self.delete_btn = Button(self.frame2, width=12, pady=8, text='Delete', font=('yu gothic ui', 13, 'bold'),
                                 cursor="hand2", bg=RED, fg=WHITE, border=0, relief=FLAT, highlightthickness=0, command=self.delete)
        self.delete_btn.place(x=200, y=20)

        self.view_btn = Button(self.frame2, width=12, pady=8, text='View', font=('yu gothic ui', 13, 'bold'),
                               cursor="hand2", bg=PINK, fg=WHITE, border=0, relief=FLAT, highlightthickness=0, command=self.view)
        self.view_btn.place(x=200, y=80)

        self.download_btn = Button(self.frame2, width=12, pady=8, text='Download', font=('yu gothic ui', 13, 'bold'),
                                   cursor="hand2", bg=LIGHT_GRAY, fg=WHITE, border=0, command=self.download)
        self.download_btn.place(x=200, y=140)
        #------------------------------------------------------#
        self.gui_done = True
