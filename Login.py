...
class Login:
    def __init__(self, window):
        ...
        self.window.attributes('-zoomed', False) # Linux
        ...
        self.heading = Label(self.lgn_frame, text=self.txt, 
                             font=('yu gothic ui', 25, 'bold'), bg='#040405', fg='white')
        ...
        self.sign_in_label = Label(self.lgn_frame, text='Sign In', 
                                   font=('yu gothic ui', 17, 'bold'), bg="#040405", fg='white')
        ...
        self.username_line = Canvas(self.lgn_frame, width=300, height=2.0, highlightthickness=0, bg='#bdb9b1')
        ...
        self.login = Button(self.lgn_button_label, text='LOGIN', font=("yu gothic ui", 13, "bold"), width=20, bd=0,
                            bg='#3047ff', cursor='hand2', activebackground='#3047ff', fg='white', highlightthickness=0)
        self.login.place(x=20, y=10)

        # Forgot password
        self.forgot_button = Button(self.lgn_frame, text="Forgot Password?",
                                    font=("yu gothic ui", 13, "bold underline"), fg="white", relief=FLAT, highlightthickness=0,
                                    activebackground="blue", borderwidth=0, background="#040405", cursor="hand2")
        self.forgot_button.place(x=610, y=510)        

        # Sign up
        self.sign_label = Label(self.lgn_frame, text='No account yet?', font=("yu gothic ui", 11, "bold"),
                                relief=FLAT, borderwidth=0, background="#040405", fg='white', highlightthickness=0,)
        ...
        self.signup_button_label = Button(self.lgn_frame, image=self.signup_img, bg='#98a65d', cursor="hand2",
                                          borderwidth=0, background="#040405", activebackground="#040405", highlightthickness=0,)
        ...
        self.password_entry = Entry(self.lgn_frame, highlightthickness=0, relief=FLAT, bg='#040405', 
                                    fg='#6b6a69', font=('yu gothic ui', 13, 'bold'), show='*')
        self.password_entry.place(x=580, y=416, width=244)

        self.password_line = Canvas(self.lgn_frame, width=300, height=2.0, highlightthickness=0, bg='#bdb9b1')
